...
function(n) {
	...
	n("#experience-timeline").each(function() {
		...
		$this.find(".vtimeline-point").each(function() {
			...
			// n(this).prepend('<div class="vtimeline-icon"><i class="fa fa-star" style="color:red"></i></div>')
			n(this).prepend('<div class="vtimeline-icon"><i class="fa fa-heart" style="color:red"></i></div>')
		}),
